...
sudo pacman -S --needed --noconfirm xorg-server xorg-server-common xorg-setxkbmap xorg-xauth xorg-xinit xorg-xinput xorg-xkbcomp xorg-xmodmap xorg-xprop xorg-xrandr xorg-xrdb xorg-xset xorg-xwayland xorgproto;
...
sudo pacman -S --needed --noconfirm i3-wm dmenu;
